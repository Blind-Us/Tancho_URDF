...
# Tancho V3 SimReady Isaac Lab / Isaac Sim environment bootstrap.
# Tested target: Isaac Sim 5.1.0, Isaac Lab v2.3.2, Python 3.11, Torch 2.7.0 cu128.
# Override defaults with: ENV_NAME=env_isaaclab INSTALL_ROOT=$HOME ./setup_tancho_v3_isaac_lab_env.sh
...
print("Tancho V3 Isaac Lab / Isaac Sim environment is ready.")
