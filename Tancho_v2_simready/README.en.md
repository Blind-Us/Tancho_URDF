...
python scripts/rsl_rl/train.py --task Template-TanchoV2-Direct-v0 --headless --num_envs 64 --max_iterations 100
```
...
- Assets stay embedded in the python package under `source/stackforce_simready_tancho_v2_lab/stackforce_simready_tancho_v2_lab/assets`.
